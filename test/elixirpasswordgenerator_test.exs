defmodule ElixirpasswordgeneratorTest do
  use ExUnit.Case
  # doctest Elixirpasswordgenerator
  ...
  setup do
    ...
    {:ok, result} = Elixirpasswordgenerator.generate(options)
  ...
  test "returns an error when no length is given" do
    ...
    assert {:error, _error} = Elixirpasswordgenerator.generate(options)
  end
  ...
  test "length of returned string is the option provided" do
    ...
    {:ok, result} = Elixirpasswordgenerator.generate(length_option)
  ...
  test "returns error when number option is not allowed" do
  ...
  test "returns string uppercase", %{options_type: options} do
    ...
    {:ok, result} = Elixirpasswordgenerator.generate(options_with_uppercase)
  ...
  test "returns string with just numbers", %{options_type: options} do
    ...
    {:ok, result} = Elixirpasswordgenerator.generate(options_with_numbers)
  ...
  test "returns string with uppercase and numbers", %{options_type: options} do
    ...
    {:ok, result} = Elixirpasswordgenerator.generate(options_included)
  ...
  test "returns string with uppercase, numbers and symbols", %{options_type: options} do
    options_included = %{
      "length" => "10",
      "numbers" => "true",
      "uppercase" => "true",
